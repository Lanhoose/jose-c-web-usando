...
private fun PoderesParanormaisCriacao(
    ...
    val automaticos = remember(p.classe, p.trilha, p.nex) {
                ...
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    if (etapaTroca == 0) {
                        ...
                        Text(
                            ...
                            else "NEX ${p.nex}% permite escolher um ritual de até ${maxCirculoPermitido}º círculo.",
                            color = TextoFraco,
                        )
                        rituaisElegiveis
                                ...
                                Button(
                                    onClick = {
                                        val novoRitual = Ritual(
                                            ...
                                            duracao = r.duracao, afinidade = r.afinidade,
            ...
            val adicionados = faltantes.mapNotNull { nome ->
                RITUAIS_COMPLETOS.firstOrNull { it.nome == nome }?.let { def ->
                    Ritual(
                        ...
                        duracao = def.duracao, afinidade = def.afinidade,
