...
data class Ritual(
    ...
    val fonte: String = "",
    /** Origem da aquisição/cadastro do ritual. Não confundir catálogo com posse. */
...
data class Personagem(
    ...
    /** Perícias recebidas da classe durante a criação; separadas da origem para a UI e regras. */
    val periciasClasseAutomaticas: List<String> = emptyList(),
...
/** Limite de carga oficial: FOR 0 = 2 espaços; FOR 1+ = 5 espaços por ponto. */
fun limiteDeCarga(forca: Int): Int = if (forca <= 0) 2 else forca * 5
