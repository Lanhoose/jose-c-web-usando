    ...
    LivroSumario(
        ...
        secoes = listOf(
            ...
            SecaoLivro("Regulae Obscurae", 74, listOf(
                ...
                ItemSumario("Trilha Monstruoso — Combatente", 80),
                ItemSumario("Trilha Monstruoso — Especialista", 81),
                ItemSumario("Trilha Monstruoso — Ocultista", 84),
            )),
...
val CONTEUDOS_ADICIONAIS = listOf(
    ...
    ref("Exorcizado", "Origem", LivroPdf.ARQUIVOS_SECRETOS, 79),
    ref("Sensitivo Rebelde", "Origem", LivroPdf.ARQUIVOS_SECRETOS, 79),
    ref("Monstruoso — Combatente", "Trilha — Combatente", LivroPdf.ARQUIVOS_SECRETOS, 80),
    ref("Monstruoso — Especialista", "Trilha — Especialista", LivroPdf.ARQUIVOS_SECRETOS, 81),
    ref("Monstruoso — Ocultista", "Trilha — Ocultista", LivroPdf.ARQUIVOS_SECRETOS, 84),
)
