...
fun FichaScreen(repo: Repositorio, id: String) {
    ...
    LazyColumn(
        ...
        item {
            ...
            var detalhesCatalogoAbertos by remember(armaLivroSelecionada) { mutableStateOf(false) }
                            ...
                            AlertDialog(
                                ...
                                text = {
                                    androidx.compose.foundation.layout.Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                        Text("Categoria: ${def.categoria}", color = TextoClaro)
                                        Text("Grupo: ${def.grupo}", color = TextoClaro)
                                        Text("Dano: ${def.dano} · Crítico: ${def.critico}", color = TextoClaro)
                                        Text("Alcance: ${def.alcance}", color = TextoClaro)
                                        Text("Tipo de dano: ${def.tipoDano}", color = TextoClaro)
                                        Text("Espaços: ${def.espacos.toString().removeSuffix(".0")}", color = TextoClaro)
                                        Text("Perícia: ${def.pericia}", color = TextoClaro)
                                        if (def.municao != "—") Text("Munição: ${def.municao}", color = TextoClaro)
