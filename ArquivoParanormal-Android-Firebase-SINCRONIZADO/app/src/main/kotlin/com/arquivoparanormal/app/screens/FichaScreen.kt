...
fun FichaScreen(repo: Repositorio, id: String, isMestre: Boolean = repo.ehMestre) {
    ...
    LazyColumn(
        ...
        item {
            ...
            val rituaisNormaisConhecidos = p.rituais.count { it.origem !in setOf("CLASSE_OCULTISTA", "TRILHA", "GRIMORIO") }
            val limiteRituais = limiteRituaisConhecidosV36(p)
            val limiteRitualAtingido = rituaisNormaisConhecidos >= limiteRituais
            ...
            Painel(
                ...
                Text(
                    "Rituais adquiridos pelo limite de INT: $rituaisNormaisConhecidos/$limiteRituais", color = if (limiteRitualAtingido) Perigo else Acento, style = MaterialTheme.typography.labelSmall,
                )
                Text(
