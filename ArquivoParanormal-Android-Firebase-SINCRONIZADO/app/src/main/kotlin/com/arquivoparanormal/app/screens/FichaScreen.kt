    ...
    LazyColumn(
        ...
        item {
            Painel(titulo = "Identificação") {
                ...
                Campo("Patente") { Text(p.patente, color = TextoClaro); Text("Derivada de ${p.prestigio} Pontos de Prestígio", color = TextoFraco, style = MaterialTheme.typography.bodySmall) }
