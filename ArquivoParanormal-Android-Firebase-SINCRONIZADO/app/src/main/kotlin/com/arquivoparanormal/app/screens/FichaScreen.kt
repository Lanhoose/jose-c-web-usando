    ...
    LazyColumn(
        ...
        item {
            ...
            Painel(
                ...
                ListaColapsavel("armas registradas", p.armas.size, vazio = "Nenhuma arma registrada.") {
                    p.armas.forEach { a ->
        ...
        item {
            Painel(
                ...
                ListaColapsavel("itens do inventário", itensVisiveis.size, vazio = "Mochila vazia.") {
        ...
        item {
            ...
            Painel(
                ...
                ListaColapsavel("rituais aprendidos", p.rituais.size, vazio = "Nenhum ritual conhecido.") {
                    p.rituais.forEach { r ->
        ...
        item {
            Painel(titulo = "Habilidades") {
                ...
                ListaColapsavel("habilidades conhecidas", nomes.size, vazio = "Nenhuma habilidade adicionada.") {
                    nomes.forEach { nome ->
                ...
                ListaColapsavel("poderes paranormais", p.poderesParanormais.size, vazio = "Nenhum poder paranormal adquirido.") {
