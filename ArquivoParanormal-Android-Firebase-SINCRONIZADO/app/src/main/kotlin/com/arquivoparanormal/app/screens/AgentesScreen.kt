    ...
    Card(
        ...
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                // A foto do jogador é sincronizada automaticamente a partir do perfil
                // do proprietário da ficha. Não existe mais ação manual nesta tela,
                // evitando que o Mestre precise solicitar/carregar a foto e evitando
                // gravações extras da ficha que poderiam causar conflitos de dados.
                if (repo.ehMestre && p.ownerUid.isNotBlank() && p.fotoJogadorThumb.isNullOrBlank()) {
                    Text("Foto do jogador: sincronizando automaticamente…", color = TextoFraco, style = MaterialTheme.typography.labelSmall)
                }
            }
