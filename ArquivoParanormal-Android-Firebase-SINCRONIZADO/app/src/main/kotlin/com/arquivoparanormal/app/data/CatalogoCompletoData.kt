...
fun fonteDoRitual(def: RitualDef): String = when {
    def in RITUAIS_LIVRO -> "Livro de Regras Oficial"
    def in RITUAIS_SOBREVIVENDO_DEFINICOES -> "Sobrevivendo ao Horror"
    else -> "Arquivos Secretos #07"
}
