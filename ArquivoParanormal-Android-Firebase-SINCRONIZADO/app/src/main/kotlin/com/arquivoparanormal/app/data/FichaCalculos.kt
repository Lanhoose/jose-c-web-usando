...
fun calcularFicha(p: Personagem): CalculosFicha {
    ...
    // Tanque de Guerra aumenta a RD que a Proteção Pesada fornece.
    // A Proteção Pesada fornece RD geral 2; portanto o bônus de Tanque
    // também é RD geral e se aplica a qualquer tipo de dano.
...
fun corrigirRecursosLegados(p: Personagem): Personagem {
    ...
    return p.copy(
        patente = patentePorPrestigio(p.prestigio),
        pvMax = calc.pvMax,
