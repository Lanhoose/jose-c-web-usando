...
fun ataqueDaArma(p: Personagem, arma: Arma): Int = bonusPericia(p, arma.pericia)
...
fun testeAtaqueDaArma(p: Personagem, arma: Arma): String {
    ...
    val dados = p.atributos[atributo] ?: 1
    return "${dados}d20${formatBonus(ataqueDaArma(p, arma))}"
}
