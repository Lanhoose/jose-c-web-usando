...
fun periciasClasseCumpreRegra(classe: String, escolhidas: Set<String>): Boolean =
    classe != "Combatente" || (
        escolhidas.any { it == "Luta" || it == "Pontaria" } &&
        escolhidas.any { it == "Fortitude" || it == "Reflexos" }
    )
...
/** Proteções básicas. A Proteção Pesada fornece RD 2 apenas contra
 * balístico, corte, impacto e perfuração, conforme o Livro de Regras.
 * A chave "Fisico" é expandida pelo motor para esses quatro tipos; não é RD geral. */
...
val MALDICOES_ARMAS_CATALOGO = listOf(
    MaldicaoCatalogoDef("Antielemento","Arma","Conhecimento","A arma é letal contra criaturas de um elemento e, por 2 PE em um ataque acertado, causa +4d8 de dano. O elemento é definido conforme a regra do livro."),
    MaldicaoCatalogoDef("Ritualística","Arma","Conhecimento","Permite armazenar um ritual compatível na arma e descarregá-lo ao acertar um ataque."),
    MaldicaoCatalogoDef("Senciente","Arma","Conhecimento","Pode imbuir a arma com consciência para fazê-la flutuar e atacar ao seu lado, pagando PE para mantê-la ativa."),
    MaldicaoCatalogoDef("Empuxo","Arma","Energia","Permite arremessar a arma em alcance curto e aumenta seu dano quando usada dessa forma; aplicável a armas corpo a corpo."),
    MaldicaoCatalogoDef("Energética","Arma","Energia","Por 2 PE, converte o dano do ataque para Energia, fornece +5 no ataque e ignora RD durante esse ataque."),
    MaldicaoCatalogoDef("Vibrante","Arma","Energia","Concede Ataque Extra da trilha Operações Especiais ou reduz seu custo em 1 PE se já possuir a habilidade."),
    MaldicaoCatalogoDef("Consumidora","Arma","Morte","Pode gastar 2 PE para, ao acertar, deixar o alvo imóvel por uma rodada."),
    MaldicaoCatalogoDef("Erosiva","Arma","Morte","Causa +1d8 de Morte e pode causar dano adicional de Morte por duas rodadas ao gastar 2 PE e acertar."),
    MaldicaoCatalogoDef("Repulsora","Arma","Morte","Concede +2 Defesa enquanto empunhada e pode fornecer +5 adicional ao fazer bloqueio por 2 PE."),
    MaldicaoCatalogoDef("Lancinante","Arma","Sangue","Causa +1d8 de Sangue, multiplicado em acertos críticos."),
    MaldicaoCatalogoDef("Predadora","Arma","Sangue","Ignora camuflagem/cobertura leves, aumenta alcance de arma à distância e duplica a margem de ameaça."),
    MaldicaoCatalogoDef("Sanguinária","Arma","Sangue","Causa sangramento cumulativo e, em crítico, pode deixar o alvo fraco e conceder PV temporários."),
)

val MALDICOES_CATALOGO = listOf(
    MaldicaoCatalogoDef("Abascanta","Proteção","Conhecimento","+5 em testes de resistência contra rituais; pode refletir um ritual uma vez por cena pagando reação e PE igual ao custo."),
    MaldicaoCatalogoDef("Profética","Proteção","Conhecimento","RD Conhecimento 10 e pode repetir um teste de resistência gastando 2 PE.",resistencias=mapOf("Conhecimento" to 10)),
    MaldicaoCatalogoDef("Sombria","Proteção","Conhecimento","+5 em Furtividade, ignora penalidade de carga nessa perícia e pode disfarçar a proteção como roupa comum."),
    MaldicaoCatalogoDef("Cinética","Proteção","Energia","+2 Defesa e RD 2 para proteção leve/escudo ou RD 5 para proteção pesada."),
    MaldicaoCatalogoDef("Lépida","Proteção","Energia","+10 Atletismo, +3m deslocamento e movimento sobrenatural por 2 PE."),
    MaldicaoCatalogoDef("Voltaica","Proteção","Energia","RD Energia 10 e pode emitir arcos que causam 2d6 Energia a adjacentes no fim dos turnos.",resistencias=mapOf("Energia" to 10)),
    MaldicaoCatalogoDef("Letárgica","Proteção","Morte","+2 Defesa e chance de ignorar dano extra de críticos e ataques furtivos."),
    MaldicaoCatalogoDef("Repulsiva","Proteção","Morte","RD Morte 10 e pode causar 2d8 Morte a quem atacar corpo a corpo.",resistencias=mapOf("Morte" to 10)),
    MaldicaoCatalogoDef("Regenerativa","Proteção","Sangue","RD Sangue 10 e pode recuperar 1d12 PV gastando movimento e 1 PE.",resistencias=mapOf("Sangue" to 10)),
    MaldicaoCatalogoDef("Sádica","Proteção","Sangue","Recebe bônus cumulativo em ataques e dano conforme sofreu dano desde o último turno."),
    MaldicaoCatalogoDef("Carisma","Acessório","Conhecimento","+1 Presença sem conceder PE adicionais."),
    MaldicaoCatalogoDef("Conjuração","Acessório","Conhecimento","Concede um ritual de 1º círculo; se já conhecer o ritual, reduz seu custo em 1 PE."),
    MaldicaoCatalogoDef("Escudo Mental","Acessório","Conhecimento","RD Mental 10.",resistencias=mapOf("Mental" to 10)),
    MaldicaoCatalogoDef("Reflexão","Acessório","Conhecimento","Uma vez por rodada, pode refletir um ritual pagando PE igual ao custo."),
    MaldicaoCatalogoDef("Sagacidade","Acessório","Conhecimento","+1 Intelecto sem conceder perícias ou graus de treinamento."),
    MaldicaoCatalogoDef("Defesa","Acessório","Energia","+5 Defesa."),
    MaldicaoCatalogoDef("Destreza","Acessório","Energia","+1 Agilidade."),
    MaldicaoCatalogoDef("Potência","Acessório","Energia","+1 na DT de habilidades, poderes e rituais."),
    MaldicaoCatalogoDef("Esforço Adicional","Acessório","Morte","+5 PE após um dia de uso."),
    MaldicaoCatalogoDef("Disposição","Acessório","Sangue","+1 Vigor."),
    MaldicaoCatalogoDef("Pujança","Acessório","Sangue","+1 Força."),
    MaldicaoCatalogoDef("Vitalidade","Acessório","Sangue","+15 PV após um dia de uso."),
    MaldicaoCatalogoDef("Proteção Elemental","Acessório","Varia","RD 10 contra um elemento escolhido; o acessório conta como item daquele elemento."),
)
