...
val CLASSES = listOf(
    ClasseDef(
        ...
        sanidade = "12",
        sanNivel = "3",
        pericias = "Luta ou Pontaria; Fortitude ou Reflexos; +1 + INT perícias à escolha",
        trilhas = listOf(
    ...
    ClasseDef(
        ...
        sanidade = "20",
        sanNivel = "5",
        pericias = "Ocultismo e Vontade; +3 + INT perícias à escolha",
        trilhas = listOf(
 ...
 * balístico, corte, impacto e perfuração. Ela não é RD geral. */
data class ProtecaoDef(
    val nome: String,
    val categoria: Int,
    val espacos: Double,
    val defesaBonus: Int,
    val resistenciaFisica: Int,
)
...
data class RitualDef(
    ...
    /** Livro/suplemento de onde este ritual foi catalogado. */
    val fonte: String = "Livro de Regras",
) {
    val simbolo: String
