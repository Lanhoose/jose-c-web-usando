...
val MALDICOES_CATALOGO = listOf(
    ...
    MaldicaoCatalogoDef("Profética","Proteção","Conhecimento","RD Conhecimento 10 e pode repetir um teste de resistência gastando 2 PE.",mapOf("Conhecimento" to 10)),
    ...
    MaldicaoCatalogoDef("Voltaica","Proteção","Energia","RD Energia 10 e pode emitir arcos que causam 2d6 Energia a adjacentes no fim dos turnos.",mapOf("Energia" to 10)),
    MaldicaoCatalogoDef("Letárgica","Proteção","Morte","+2 Defesa e chance de ignorar dano extra de críticos e ataques furtivos."),
    MaldicaoCatalogoDef("Repulsiva","Proteção","Morte","RD Morte 10 e pode causar 2d8 Morte a quem atacar corpo a corpo.",mapOf("Morte" to 10)),
    MaldicaoCatalogoDef("Regenerativa","Proteção","Sangue","RD Sangue 10 e pode recuperar 1d12 PV gastando movimento e 1 PE.",mapOf("Sangue" to 10)),
    ...
    MaldicaoCatalogoDef("Escudo Mental","Acessório","Conhecimento","RD Mental 10.",mapOf("Mental" to 10)),
