...
/**
 * Resumo curto das trilhas para a criação de personagem.
 * O texto é intencionalmente resumido para caber no app; os valores exatos
 * de pré-requisitos e progressão continuam sendo os do catálogo/regras.
 */
val DESCRICOES_TRILHAS: Map<String, String> = mapOf(
    "Aniquilador" to "Focado em causar dano. Recebe benefícios para aumentar sua eficiência ofensiva e finalizar ameaças.",
    "Comandante de Campo" to "Lidera aliados em combate, criando oportunidades e melhorando a atuação do grupo.",
    "Guerreiro" to "Especialista em combate corpo a corpo, ganhando recursos para atacar e resistir melhor na linha de frente.",
    "Operações Especiais" to "Aprimora mobilidade, precisão e eficiência tática, favorecendo ações rápidas e decisivas.",
    "Tropa de Choque" to "Transforma resistência em vantagem de combate, tornando o personagem mais difícil de derrubar.",
    "Atirador de Elite" to "Especializado em ataques à distância, melhorando precisão e eficiência quando luta de longe.",
    "Infiltrador" to "Focado em furtividade e surpresa, recebendo recursos para agir sem ser percebido e explorar aberturas.",
    "Médico de Campo" to "Especializado em suporte e recuperação, melhorando a capacidade de tratar e manter aliados em combate.",
    "Negociador" to "Usa Presença e interação social para influenciar pessoas, controlar situações e obter vantagens narrativas.",
    "Técnico" to "Especialista em tecnologia e equipamentos, tornando ferramentas e recursos técnicos mais eficientes.",
    "Agente Secreto" to "Mistura investigação, infiltração e adaptação, oferecendo recursos para missões discretas e versáteis.",
    "Caçador" to "Especialista em rastrear e enfrentar alvos específicos, ganhando vantagens contra ameaças estudadas.",
    "Erudito" to "Aprofunda conhecimento e investigação, ampliando a capacidade de compreender pistas, fenômenos e informações.",
    "Perseverante" to "Focado em continuar atuando sob pressão, recebendo recursos para resistir e superar situações difíceis.",
    "Conduíte" to "Canaliza o paranormal com eficiência, fortalecendo o uso de rituais e sua flexibilidade paranormal.",
    "Flagelador" to "Converte sacrifício e sofrimento em poder, usando o próprio corpo como parte do custo de seus recursos.",
    "Graduado" to "Aprofunda domínio de rituais, ampliando a capacidade de aprender e utilizar conhecimento paranormal.",
    "Intuitivo" to "Confia em instinto e percepção do Outro Lado, reagindo melhor a situações paranormais e riscos inesperados.",
    "Lâmina Paranormal" to "Combina combate corpo a corpo e paranormal, usando rituais para tornar seus ataques mais perigosos.",
    "Durão" to "Aumenta a resistência física e a capacidade de permanecer de pé mesmo depois de sofrer muito dano.",
    "Esperto" to "Aproveita inteligência e criatividade para obter vantagens, resolver problemas e explorar oportunidades.",
    "Esotérico" to "Desenvolve uma ligação maior com o paranormal, obtendo recursos para lidar com fenômenos e conhecimentos ocultos.",
    "Monstruoso — Combatente" to "Variante de Combatente de Sobrevivendo ao Horror, com preparação ritualística diária e transformação ligada a um elemento.",
    "Bibliotecário" to "Trilha de Especialista focada em leitura, conhecimento e uso de Intelecto para adaptar perícias.",
    "Muambeiro" to "Trilha de Especialista focada em fabricar, reparar e improvisar equipamentos e itens.",
    "Parapsicólogo" to "Trilha de Especialista focada em tratar a mente e restaurar a sanidade, com exigência de Profissão (psicólogo).",
    "Exorcista" to "Trilha de Ocultista focada em fé, resistência mental e potencialização de rituais.",
    "Possuído" to "Trilha de Ocultista em que uma entidade cresce dentro do personagem, concedendo uma reserva de pontos de possessão.",
    "Monstruoso — Especialista" to "Versão paranormal da classe, voltada para ampliar versatilidade e capacidades técnicas.",
    "Monstruoso — Ocultista" to "Versão paranormal da classe, voltada para ampliar capacidades e recursos ligados ao Outro Lado.",
)
...
val CLASSES = listOf(
    ...
    ClasseDef(
        ...
        trilhas = listOf(
            ...
            "Agente Secreto", "Caçador", "Erudito", "Perseverante", "Bibliotecário", "Muambeiro", "Parapsicólogo", "Monstruoso — Especialista",
        ),
    ...
    ClasseDef(
        ...
        trilhas = listOf(
            ...
            "Exorcista", "Possuído", "Monstruoso — Ocultista",
        ),
    ...
    ClasseDef(
        ...
        desc = "Classe especial de Sobrevivendo ao Horror. Usa progressão por Estágios, não a progressão normal por NEX; por isso, os valores de PV/PE/SAN devem seguir os Estágios da classe.",
    ),
)
...
val ORIGENS = listOf(
    ...
    OrigemDef("Atleta", "Acrobacia, Atletismo", "110%"),
    OrigemDef("Chef", "Fortitude, Profissão (cozinheiro)", "Ingrediente Secreto"),
    OrigemDef("Criminoso", "Crime, Furtividade", "O Crime Compensa"),
    OrigemDef("Cultista Arrependido", "Ocultismo, Religião", "Traços do Outro Lado"),
    OrigemDef("Desgarrado", "Fortitude, Sobrevivência", "Calejado"),
    OrigemDef("Engenheiro", "Profissão, Tecnologia", "Ferramenta Favorita"),
    OrigemDef("Executivo", "Diplomacia, Profissão", "Processo Otimizado"),
    OrigemDef("Investigador", "Investigação, Percepção", "Faro para Pistas"),
    OrigemDef("Lutador", "Luta, Reflexos", "Mão Pesada"),
    OrigemDef("Magnata", "Diplomacia, Pilotagem", "Patrocinador da Ordem"),
    OrigemDef("Mercenário", "Iniciativa, Intimidação", "Posição de Combate"),
    OrigemDef("Militar", "Pontaria, Tática", "Para Bellum"),
    ...
    OrigemDef("Servidor Público", "Intuição, Vontade", "Espírito Cívico"),
    OrigemDef("Teórico da Conspiração", "Investigação, Ocultismo", "Eu Já Sabia"),
    OrigemDef("T.I.", "Investigação, Tecnologia", "Motor de Busca"),
    OrigemDef("Trabalhador Rural", "Adestramento, Sobrevivência", "Desbravador"),
    OrigemDef("Trambiqueiro", "Crime, Enganação", "Impostor"),
    OrigemDef("Universitário", "Atualidades, Investigação", "Dedicação"),
    OrigemDef("Vítima", "Reflexos, Vontade", "Cicatrizes Psicológicas"),
)
...
val CONDICOES = listOf(
    ...
    CondicaoDef("Morrendo", "Você não pode se mover nem realizar ações enquanto estiver Morrendo. No início de cada turno, faça o teste de morte indicado pelas regras; sair dessa condição exige estabilização ou os efeitos apropriados.", grave = true),
...
fun custoRitualPorCirculo(circulo: String): Int = when (circulo) {
    "1º" -> 1
    "2º" -> 3
    "3º" -> 6
    "4º" -> 10
...
data class RitualDef(
    ...
    val custoPE: Int = custoRitualPorCirculo(circulo),
    val discenteExtraPE: Int = 0,
    val verdadeiroExtraPE: Int = 0,
    val requisitoDiscente: String = "",
    val requisitoVerdadeiro: String = "",
) {
    val simbolo: String
