...
/**
 * Camada pública interna da GeTech.
 *
        ...
        LazyColumn(
            ...
            item {
                TechCard {
                    ...
                    Spacer(Modifier.height(8.dp))
                    Text(
                        "Área pública do ERP GeTech. Acesso liberado após autenticação de Gestor.",
  ...
  LazyColumn(Modifier.padding(pad).padding(horizontal=18.dp,vertical=22.dp),verticalArrangement=Arrangement.spacedBy(18.dp)){
   item{TechCard{
     ...
     Row(Modifier.fillMaxWidth(),horizontalArrangement=Arrangement.spacedBy(8.dp)){
       ...
       SecondaryButton("Acessar área do Gestor",Modifier.weight(1f)){onPage("funcionalidades")}
     }
   }}
