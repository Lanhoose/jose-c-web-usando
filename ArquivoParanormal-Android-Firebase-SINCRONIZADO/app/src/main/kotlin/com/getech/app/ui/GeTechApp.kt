...
fun GeTechApp(
    ...
    when(val r=route) {
        Route.Home -> HomeScreen(
            ...
            onPage={ key ->
                if (repo.session()?.role?.lowercase() == "gestor") route = Route.Public(key)
                else route = Route.Login
            },
        ...
        Route.Client -> {
            ...
            else ClientDashboard(repo,{route=Route.Chatbot},{route=Route.AR},{route=Route.Public(it)},
